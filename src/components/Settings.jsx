  ...
  return (
    <div className="sp-tab-content">
      ...
      <div className="sp-section-header" style={{ marginBottom: 4 }}>
        ...
        <p className="sp-section-desc">Integrations that are live and syncing with Sudarshanaaa.</p>
      </div>
...
function PluginsTab() {
  const plugins = [
    { name: "Sudarshanaaa NLP Pack",   author: "Sudarshanaaa Labs", skills: "Social engineering, urgency detection, BEC patterns", updated: "Jun 2025", enabled: true  },
    { name: "GeoIP Risk Engine",      author: "Sudarshanaaa Labs", skills: "IP geolocation, ASN reputation, VPN/proxy detection",  updated: "May 2025", enabled: true  },
    { name: "YARA Rule Engine",       author: "Sudarshanaaa Labs", skills: "Attachment pattern matching, malware signatures",       updated: "Apr 2025", enabled: true  },
  ...
  return (
    <>
      <style>{`
        ...
        .sp-sidebar-search .material-icons-round {
          font-size: 17px;
          color: var(--text-dimmer, #777);
        }
        ...
        .sp-nav-item .material-icons-round {
          font-size: 18px;
          flex-shrink: 0;
        }
        ...
        .sp-segmented-btn.active {
          background: var(--panel, rgba(255,255,255,0.14));
          color: var(--text, #f0f0f0);
        }
        ...
        .sp-switch.on {
          background: var(--accent-dim, rgba(200,240,96,0.25));
        ...
        .sp-radio {
          ...
          border-radius: 999px;
          flex-shrink: 0;
          border: 2px solid var(--border-2, rgba(255,255,255,0.1));
          position: relative;
        }
        ...
        .sp-pw-top .sp-field-group-narrow {
          max-width: 360px;
          flex: 1;
        }
        .sp-pw-top .sp-pw-rules {
        ...
        .da-icon-wrap .material-icons-round {
          font-size: 20px;
          color: #e63946;
        }
        .da-title {
